...
class StageAdmin(admin.ModelAdmin):
    list_display = ('candidature', 'date_debut', 'date_fin', 'statut', 'valide')
    list_filter = ('statut', 'valide', 'enseignant')
    search_fields = ('candidature__etudiant__user__username', 'candidature__offre__titre')
    raw_id_fields = ('candidature', 'enseignant')
    date_hierarchy = 'date_debut'
    fieldsets = (
        (None, {
            'fields': ('candidature', 'enseignant', 'statut', 'valide')
        }),
        ('Dates', {
            'fields': ('date_debut', 'date_fin', 'date_fin_reelle')
        }),
        ('Tuteur', {
            'fields': ('tuteur_entreprise',)
        }),
        ('Validation', {
